...
public static class AgentRunResponseExtensions
{
    ...
    public static AgentResponse ToAgentResponse(this AgentRunResponse agentRunResponse, AgentThread agentThread)
    {
        ...
        if (agentThread != null)
        {
            ...
            var extractedThreadId = ExtractThreadId(agentThread);
            response.ThreadId = extractedThreadId;
        }
    ...
    private static string ExtractThreadId(AgentThread agentThread)
    {
        ...
        try
        {
            ...
            if (jsonElement.TryGetProperty("storeState", out var conversationIdElement))
            {
